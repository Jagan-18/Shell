...
### Additional Notes:
### Google App Password: If you don't have an app-specific password yet, go to Google Account Settings > App passwords to generate one. Use that app password instead of your Gmail password.

### Check Gmail Settings: Make sure that Less Secure App Access is enabled on your Google account or use an app password as mentioned above.

### Troubleshooting: If the email doesn't send, check Postfix logs at /var/log/maillog for errors:
